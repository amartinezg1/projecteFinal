...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="{{ asset('css/colorselect.css') }}" rel="stylesheet" type="text/css" />   
    
     <script src="{{ asset('src/jquery.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/Common.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/jquery.form.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/jquery.validate.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/datepicker_lang_US.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/jquery.datepicker.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/jquery.dropdown.js') }}" defer type="text/javascript"></script>  
     <script src="{{ asset('src/Plugins/jquery.colorselect.js') }}" defer type="text/javascript"></script>  
