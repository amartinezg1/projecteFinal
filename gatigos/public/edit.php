...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>
    ...
    <link href="css/colorselect.css" rel="stylesheet" type="text/css" />
        ...
        $(document).ready(function() {
            ...
            $("#Deletebtn").click(function() {
                 if (confirm("Are you sure to remove this event")) {
                    var param = [{ "name": "calendarId", value: $('#idDelete').val()}];
    ...
    <div>
      <div class="toolBotton">
        ...
        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);">
          <span class="Delete" title="Cancel the calendar">Borrar(<u>D</u>)
          </span>
        </a>
        <?php } ?>
      ...
      <div class="infocontainer">
        ...
        <input id="idDelete" value="<?php echo $event->Id?>" type="hidden"></input>
          <label>
            <span>                        *Nombre:
            </span>
            ...
            Veterinario id: <input id="colorvalue" name="colorvalue" type="number" value="" />
          ...
          <label>
            ...
            <div>
              ...
              <label class="checkp">
                <input id="IsAllDayEvent" name="IsAllDayEvent" type="checkbox" value="1" <?php if($all_day_event) {echo "checked";} ?>/>          Evento diario
              </label>
            </div>
          </label>
          <label>
